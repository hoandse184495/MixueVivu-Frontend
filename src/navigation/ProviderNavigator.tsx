...
export default function ProviderNavigator({
  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        name="MyToursTab"
        component={MyToursStack}
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon name="My Tours" focused={focused} />
          ),
        }}
      />
      ...
      <Tab.Screen
        name="AddTourTab"
        component={ProviderAddTourScreen}
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon name="Add Tour" focused={focused} />
          ),
        }}
      />
