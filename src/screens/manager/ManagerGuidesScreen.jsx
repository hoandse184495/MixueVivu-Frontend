...
export default function ManagerGuidesScreen() {
    ...
    const fetchGuides = useCallback(async () => {
        ...
        try {
            ...
            Alert.alert('Lỗi', ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || 'Không thể tải danh sách hướng dẫn viên');
        }
        finally {
            setLoading(false);
        }
    ...
    const handleDelete = (id) => {
        Alert.alert('Xác nhận xóa', 'Bạn có chắc chắn muốn xóa hướng dẫn viên này không?', [
            { text: 'Hủy', style: 'cancel' },
            {
                ...
                onPress: async () => {
                    ...
                    try {
                        ...
                        Alert.alert('Lỗi', ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || 'Không thể xóa hướng dẫn viên');
                    }
                },
            },
        ]);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            Alert.alert('Lỗi', ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || 'Lỗi khi lưu thông tin hướng dẫn viên');
        }
    };
    const renderGuideCard = ({ item }) => {
        var _a;
        const initials = item.name ? (_a = item.name.split(' ').pop()) === null || _a === void 0 ? void 0 : _a.charAt(0).toUpperCase() : '👤';
    ...
    return (<SafeAreaView style={styles.safeArea}>
      ...
      {loading && guides.length === 0 ? (<View style={styles.loadingContainer}>
          <ActivityIndicator size="large" color={COLORS.primary}/>
          <Text style={styles.loadingText}>Đang tải danh sách HDV...</Text>
        </View>) : (<FlatList data={guides} keyExtractor={(item) => item.id.toString()} renderItem={renderGuideCard} contentContainerStyle={styles.listContent} showsVerticalScrollIndicator={false} onRefresh={fetchGuides} refreshing={loading} ListEmptyComponent={<View style={styles.emptyContainer}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput style={styles.textInput} placeholder="Ví dụ: Nguyễn Văn A" placeholderTextColor={COLORS.textMuted} value={fullName} onChangeText={setFullName}/>
            </View>

            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>Email *</Text>
              <TextInput style={styles.textInput} placeholder="email@address.com" placeholderTextColor={COLORS.textMuted} keyboardType="email-address" autoCapitalize="none" value={email} onChangeText={setEmail}/>
            </View>

            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>Số điện thoại</Text>
              <TextInput style={styles.textInput} placeholder="Số điện thoại liên hệ" placeholderTextColor={COLORS.textMuted} keyboardType="phone-pad" value={phone} onChangeText={setPhone}/>
            </View>

            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>Giới thiệu ngắn (Bio)</Text>
              <TextInput style={[styles.textInput, styles.textArea]} placeholder="Mô tả kỹ năng, kinh nghiệm..." placeholderTextColor={COLORS.textMuted} multiline={true} numberOfLines={3} value={bio} onChangeText={setBio}/>
            </View>
