...
export default function RegisterScreen({ navigation }) {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            const refreshToken = (_a = response.data.data) === null || _a === void 0 ? void 0 : _a.refreshToken;
            if (refreshToken) {
                try {
            ...
            Alert.alert('Thành công', accountType === 'provider'
            ...
            const message = ((_c = (_b = error.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.message) || 'Có lỗi xảy ra';
    ...
    const renderInput = ({ field, label, value, onChangeText, keyboardType, secureTextEntry, autoCapitalize = 'sentences', }) => {
        ...
        <TextInput style={[
            ...
            ]} value={value} keyboardType={keyboardType || 'default'} secureTextEntry={secureTextEntry} autoCapitalize={autoCapitalize} onFocus={() => setFocusedField(field)} onBlur={() => setFocusedField(null)} onChangeText={(nextValue) => {
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.segment}>
              <TouchableOpacity style={[styles.segmentItem, accountType === 'user' && styles.segmentItemActive]} onPress={() => setAccountType('user')}>
                <Text style={[styles.segmentText, accountType === 'user' && styles.segmentTextActive]}>
                  Khách hàng
                </Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.segmentItem, accountType === 'provider' && styles.segmentItemActive]} onPress={() => setAccountType('provider')}>
            ...
            {accountType === 'provider' ? (<>
                ...
                <View style={styles.inputGroup}>
                  ...
                  <TextInput style={styles.textInput} value={companyAddress} onChangeText={setCompanyAddress}/>
                </View>

                <View style={styles.inputGroup}>
                  <Text style={styles.inputLabel}>Mã giấy phép kinh doanh</Text>
                  <TextInput style={styles.textInput} value={businessLicense} onChangeText={setBusinessLicense} autoCapitalize="none"/>
                </View>

                <View style={styles.inputGroup}>
                  <Text style={styles.inputLabel}>Giới thiệu công ty</Text>
                  <TextInput style={[styles.textInput, styles.textArea]} value={description} onChangeText={setDescription} multiline numberOfLines={3}/>
                </View>
              </>) : null}
